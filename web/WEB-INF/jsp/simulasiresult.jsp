        ...
        <div class="container-fluid">    
            <div class="form-style-10">
                    ...
                    <div class="inner-wrap">
                        <form:form action="${pageContext.request.contextPath}/simulasi/simulasiresult" modelAttribute="cekTarif" method="POST">
                            <form:select path="kotaAsal">
                                <c:forEach var="c" items="${kota}">
                                    <form:option path="kotaAsal" value="${c.kodeKota}" name="search" placeholder="Kota Asal"> ${c.namaKota}</form:option>
                                </c:forEach>
                            </form:select> <br/>ke<br/>
                            <form:select path="kotaTujuan">
                                <c:forEach var="c" items="${kota}">
                                    <form:option path="kotaTujuan" value="${c.kodeKota}" type="text" name="search" placeholder="Kota Tujuan"> ${c.namaKota}</form:option>
                                </c:forEach>
                            </form:select><br/>
                            <form:label path="beratBarang">Berat Barang</form:label><br/>
                            <form:input path="beratBarang" name="search" placeholder="Berat"/><br/>
                            <form:button name="submitButton" value="submit"><i class="fa fa-search"></i></form:button>
                        </form:form>
                    </div>
            ...
            <div align="center" class="row">
                <div class="col-md-4 p-4">
                    ...
                    <p class="my-4">Rp. ${berat.beratBarang * tarif.reguler}</p>
                </div>
                <div class="col-md-4 p-4">
                    <img class="#">
                    ...
                    <p class="my-4">Rp. ${berat.beratBarang * tarif.kilat}</p>
                </div>
                <div class="col-md-4 p-4">
                    <img class="#">
                    ...
                    <p class="my-4">Rp. ${berat.beratBarang * tarif.ons}</p>
                </div>
            </div>
            <div  align="center" class="row">
                <div class="col-md-4 p-4">
                    ...
                    <p class="my-4">Rp. ${berat.beratBarang * tarif.sds}</p>
                </div>
                <div class="col-md-4 p-4">
                    <img class="#">
                    <!--<img class="img-fluid d-block rounded-circle mx-auto" src="https://pingendo.github.io/templates/sections/assets/test_carlito.jpg">-->
                    <p><b>Holiday Service (HDS)</b>
                        <br>Estimation : <b>1 - 2 Days</b></p>
                    <p class="my-4">Rp. ${berat.beratBarang * tarif.hds}</p>                
                </div>
            </div>            
